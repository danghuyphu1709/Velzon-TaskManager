                                                ...
                                                <div class="col-md">
                                                    <div>
                                                        ...
                                                        <div class="hstack gap-3 flex-wrap">
                                                            <div>
                                                                <i class="ri-building-line align-bottom me-1"></i>{{ $space->AccessLevelSpace->access_name }}
                                                            </div>
                                                            <div class="vr"></div>
                                                            <div> Thời gian tạo : <span
                                                                    class="fw-medium">{{ $space->created_at->diffForHumans(\Illuminate\Support\Carbon::now()) }}</span>
                                                            </div>
                                                            <div class="vr"></div>
                                                            <div class="vr"></div>
                                                                        ...
                                                                        <div class="card card-height-100">
                                                                            <div class="card-body">
                                                                                <div class="d-flex flex-column h-100">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a class="dropdown-item"
                                                                                                               href="{{ route('bang.show',$table->code) }}"><i
                                                                                    ...
                                                                                    <a href="{{ route('bang.show',$table->code) }}"
                                                                                       class="text-body">
                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col text-end dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        ...
                                                                        @endif
                                                                        <form
                                                                            action="{{ route('space.destroy',['spaces' => $space->code, 'user' => $item->id]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3">
                                    ...
                                    <textarea class="form-control"
                                              name="space_description">{{ $space->space_description }}</textarea>
                                </div>
