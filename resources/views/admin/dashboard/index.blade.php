                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ count($tables) }}">0</span></h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ $taskActive }}">0</span></h2>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ $deactivate }}">0</span></h2>
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i class="ri-arrow-up-line align-middle"></i> 0.63 % </span> vs. previous month</p>
                                </div>
                                <div>
                                    <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="table-responsive table-card mb-4">
                                <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="id"><a href="#" class="fw-medium link-primary">#{{ $table->code }}</a></td>
                                        <td class="project_name"><a href="" class="fw-medium link-primary">{{ $table->title }}</a></td>
                                        <td>
                                            <div class="text-truncate-two-lines">
                                                @foreach($table->tasks as $item)
                                                    <span class="badge bg-danger text-uppercase">{{ $item->task_name }}</span>
                                                @endforeach
                                            </div>
                                        </td>
                                        ...
                                        <td class="status"><span class="badge bg-secondary-subtle text-secondary text-uppercase">{{ $table->AccessLevelTables->access_name }}</span></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
