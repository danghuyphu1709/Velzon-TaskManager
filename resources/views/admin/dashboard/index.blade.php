        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Dự án</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ count($tables) }}">0</span>
                                        </h2>
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Nhiệm vụ</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ count($tasks) }}">0</span>
                                        </h2>
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0"> <i
                                                    class="ri-arrow-down-line align-middle"></i> 0.87 %</span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Nhiệm vụ hoàn thành</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ $taskCompleted }}">0</span>
                                        </h2>
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-danger mb-0"> <i
                                                    class="ri-arrow-down-line align-middle"></i> 2.52 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Nhiệm vụ đang triển khai</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ $taskActive }}">0</span>
                                        </h2>
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                ...
                <div class="row">
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Người dùng tham gia</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ count($users) }}">0</span>
                                        </h2>
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                    class="ri-arrow-up-line align-middle"></i> 17.32 %</span> vs.
                                            previous month</p>
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Nhiệm vụ chờ triển khai </p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value"
                                                                                        data-target="{{ $deactivate }}">0</span>
                                        </h2>
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                    class="ri-arrow-up-line align-middle"></i> 0.63 % </span> vs.
                                            previous month</p>
                    ...
                    {{--                                <div>--}}
                    {{--                                    <p class="fw-medium text-muted mb-0">Nhiệm vụ hoàn thành</p>--}}
                    {{--                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="{{ $taskCompleted }}">0</span></h2>--}}
                                ...
                                <div class="table-responsive table-card mb-4">
                                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="project_name">Dự án</th>
                                            <th class="sort" data-sort="tasks_name">Nhiệm vụ</th>
                                            <th class="sort" data-sort="client_name">Người dùng tạo</th>
                                            <th class="sort" data-sort="assignedto">Người tham gia</th>
                                            <th class="sort" data-sort="due_date">Ngày tạo</th>
                                            <th class="sort" data-sort="status">Quyền truy cập</th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($tables as $table)
                                            <tr>
                                                ...
                                                <td class="id"><a href="#"
                                                                  class="fw-medium link-primary">#{{ $table->code }}</a>
                                                </td>
                                                <td class="project_name"><a href=""
                                                                            class="fw-medium link-primary">{{ $table->title }}</a>
                                                </td>
                                                <td>
                                                    <div class="text-truncate-two-lines">
                                                        @foreach($table->tasks as $item)
                                                            <span
                                                                class="badge bg-danger text-uppercase">{{ $item->task_name }}</span>
                                                        @endforeach
                                                    </div>
                                                </td>
                                                @foreach($table->users as $user)
                                                    @if($user->pivot->is_created == \App\Enums\UserHasRole::admin->value)
                                                        <td class="client_name">{{ $user->name }}</td>
                                                    @endif
                                                @endforeach
                                                <td class="assignedto">
                                                ...
                                                <td class="due_date">{{ \Carbon\Carbon::parse($table->created_at)->translatedFormat('d F Y') }}</td>
                                                <td class="status"><span
                                                        class="badge bg-secondary-subtle text-secondary text-uppercase">{{ $table->AccessLevelTables->access_name }}</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                            ...
                                            <div data-simplebar style="height: 95px;">
                                                <ul class="list-unstyled vstack gap-2 mb-0">
                                                    ...
                                                    <li>
                                                        <div class="form-check d-flex align-items-center">
                                                            <input class="form-check-input me-3" type="checkbox"
                                                                   name="assignedTo[]" value="avatar-4.jpg"
                                                                   id="mary-gant">
                                                            <label class="form-check-label d-flex align-items-center"
                                                                   for="mary-gant">
                                                                    <span class="flex-shrink-0">
                                                    ...
                                                    <li>
                                                        <div class="form-check d-flex align-items-center">
                                                            <input class="form-check-input me-3" type="checkbox"
                                                                   name="assignedTo[]" value="avatar-9.jpg"
                                                                   id="diego-norris">
                                                            <label class="form-check-label d-flex align-items-center"
                                                                   for="diego-norris">
                                                                    <span class="flex-shrink-0">
