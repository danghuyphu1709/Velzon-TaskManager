...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/xoa-thong-bao',[HomeController::class,'index'])->name('notification.delete');
    ...
    Route::middleware('auth.table')->group(function () {
...
Route::middleware('auth.system')->group(function () {
    Route::prefix('quan-ly/')->group(function () {
        ...
        Route::get('phan-quyen/{user}',[UserController::class,'createUserRole'])->name('admin.role.create');

        Route::post('phan-quyen/{user}',[UserController::class,'storeUserRole'])->name('admin.role.store');
    });
});
...
Route::get('/test', function () {
 dd(\App\Enums\SystemRoles::admins());
